exports.getListWithAddRemoveJSText = function(page) {
    let result =
`import { add${page.item.name.capitaliseFirstLetter()}, delete${page.item.name.capitaliseFirstLetter()}, get${page.item.name.capitaliseFirstLetter()}s } from './api.js';
