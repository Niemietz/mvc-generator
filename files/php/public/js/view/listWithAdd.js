exports.getListWithAddJSText = function(page) {
    let result =
...
const mdl${page.item.name.capitaliseFirstLetter()}Id = "mdl-add-${page.item.name.replaceAt(0, item.page.item.name.charAt(0).toLowerCase())}"
