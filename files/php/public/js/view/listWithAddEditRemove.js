...
exports.getText = function(page) {
    let result =
`import { add${page.item.name.replaceAll("-", "_").capitaliseFirstLetter()}, edit${page.item.name.replaceAll("-", "_").capitaliseFirstLetter()}, delete${page.item.name.replaceAll("-", "_").capitaliseFirstLetter()}, get${page.item.name.replaceAll("-", "_").capitaliseFirstLetter()}, get${page.item.name.replaceAll("-", "_").capitaliseFirstLetter()}s } from './../api.js';
