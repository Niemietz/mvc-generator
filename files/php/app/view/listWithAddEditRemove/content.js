exports.getListWithAddEditRemoveContentText = function(page) {
    let result =
`<div class="row">
    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
        <button type="button" class="btn btn-primary" data-mdb-toggle="modal" data-mdb-target="#mdl-add-edit-${page.item.name.replaceAt(0, item.page.item.name.charAt(0).toLowerCase())}">
            Adicionar
        </button>
    </div>
</div>
